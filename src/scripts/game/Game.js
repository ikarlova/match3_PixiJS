...
export class Game extends Scene {
    create() {
        ...
        this.comboManager = new ComboManager(this.board);
        this.removeStartMatches();
    }

    removeStartMatches() {
        let matches = this.comboManager.getMatches(); 
        ...
        while(matches.length) { 
            ...
            matches = this.comboManager.getMatches();
        }
    }
    ...
    swap(selectedTile, tile, reverse){
        ...
        tile.moveTo(selectedTile.field.position, 0.2).then(() => {
            ...
            if (!reverse) {
                const matches = this.comboManager.getMatches();
                if (matches.length) {
    ...
    clearSelection(){
        if(this.selectedTile){
            this.selectedTile.field.deselect();
